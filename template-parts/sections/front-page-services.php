...
<section class="services-section">
    <div class="services-section__container">
        ...
        <div class="services-tabs" role="tablist" aria-label="Напрямки роботи">
            <button class="services-tabs__item services-tabs__item--active" type="button" role="tab" aria-selected="true">Фінансовий консалтинг<br>та управління прибутковістю</button>
            <button class="services-tabs__item" type="button" role="tab" aria-selected="false">Корпоративне управління</button>
            <button class="services-tabs__item" type="button" role="tab" aria-selected="false">Due Diligence та<br>інвестиційний супровід</button>
            <button class="services-tabs__item" type="button" role="tab" aria-selected="false">Юридична архітектура<br>та захист активів</button>
        </div>
