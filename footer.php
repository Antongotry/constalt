...
<footer class="site-footer">
    <div class="site-footer__container">
        ...
        <div class="site-footer__bottom">
            <a class="site-footer__meta-link" href="#privacy">Політика конфіденційності</a>
            <a class="site-footer__meta-link" href="#offer">Договір оферти</a>
            <a class="site-footer__meta-link" href="https://www.instagram.com/gleb_kpk?igsh=bDRoZWpyajJxMjBw" target="_blank" rel="noopener noreferrer">Розроблено в Artko</a>
        </div>
    </div>
</footer>
</div>
